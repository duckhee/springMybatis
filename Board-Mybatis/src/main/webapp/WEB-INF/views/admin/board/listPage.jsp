        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              	...
              	<thead>
                	...
                	<tbody>
                		<c:forEach items="${list}" var="board">
                			<tr style="text-align:center;">
                				<td ><input type="checkbox"  name="check" value="<c:out value='${board.idx}'/>"></td>
                				<td><a class="moveBoard" href="<c:out value='${board.idx }'/>"><c:out value='${board.title }'/></a></td>
                				<td><c:out value="${board.writer }"/></td>
                				<td><span class="badge bg-aqua"><c:out value='${board.viewcnt }'/></span></td>
                				<td><span class="badge bg-purple"><c:out value="${board.replies.length eq null ? 0 : board.replies.length} "/></span></td>
              ...
              <div class="dataTables_paginate paging_simple_numbers" id="paging" style="text-align:center;">
              	<ul class="pagination">
...
<!-- Paging, Remove, Modify, Create, Search -->
<script type="text/javascript">
	$(document).ready(function(){
		/** Create Board */
		$("#createBtn").click(function(){
			self.location = "<c:url value='/admin/boards/create'/>";
		});
		/** Move View Board */
		$(".moveBoard").click(function(e){
			e.preventDefault();
			console.log($(this).attr("href"));
			self.location="<c:url value='/admin/boards/view'/>" + "?bno=" + $(this).attr("href");
		})
		/** List Move Board */
		$(".paginate_button a").on("click", function(e){
			e.preventDefault();
			console.log("Get Page : " + $(this).attr("href"));
			/** TODO Change Form Action */
			self.location="<c:url value='/admin/boards/list'/>" + "?page=" + $(this).attr("href");
		});
	});
</script>
</body>
