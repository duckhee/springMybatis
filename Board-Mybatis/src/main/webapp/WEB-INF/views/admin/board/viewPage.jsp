        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">View Board</h3>
                    ...
                    <form role="form" name="formContent" id="formContent" method="" action="">
                      <!-- <input type="hidden" name="_csrf" value=""> -->
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title" readonly value="<c:out value='${board.title}'/>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"name="writer" id="writer"  class="form-control" readonly value="<c:out value='${board.writer}'/>">
...
<script>
  $(document).ready(function(){    
    ...
    CKEDITOR.instances.content.setData("<c:out value='${board.content}'/>");
  });
</script>
</body>
</html>
